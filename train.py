...
from gyromatman import config
from gyromatman import losses
from gyromatman.utils import set_seed, get_logging, get_inverted_triples
from gyromatman.runner import Runner
from gyromatman.models import *
...
def config_parser(parser):
    ...
    # Model
    parser.add_argument("--model", default="tgspdle", type=str, help="Model type: tgspdle, tggr, tgspdlegr")
    ...
    parser.add_argument("--pdim", default=4, type=int, help="Dimensions of subspaces for the model.") 
    parser.add_argument("--kdim", default=4, type=int, help="Dimensions of subspaces for the model.") 
    ...
    parser.add_argument("--use_hrh_spd", default=1, type=int, help="Whether to use HRH or RHR in lhs op.")
    parser.add_argument("--use_hrh_gr", default=1, type=int, help="Whether to use HRH or RHR in lhs op.")
    ...
    parser.add_argument("--neg_sample_size", default=10, type=int, help="Negative sample size, -1 to not use")
    parser.add_argument("--double_neg", action="store_true", default=False,
                        help="Whether to negative sample both head and tail entities")

    # optim and config
    parser.add_argument("--optim", default="adamw", type=str, help="Optimization method.")
    ...
    parser.add_argument("--dist_factor", default=1, type=float, help="Factor of weighted dist between spd and gr parts.")
...
def get_model(args, saved_data=None):        
    if args.model == "tgspdle":
        model = TgSPDLEModel(args)      
    elif args.model == "tggr":
